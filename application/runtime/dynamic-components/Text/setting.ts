import { ComponentTextSchemaSettingsMap } from ".";
import { ComponentSchemaSettings, valdiateComponentSetting } from "../core";

export function parseTextComponentSettings(settings: ComponentSchemaSettings): ComponentSchemaSettings {
    ...
    for (let setting in settings) {
        ...
        let settingConfig = (ComponentTextSchemaSettingsMap as any)?.[settingName];
