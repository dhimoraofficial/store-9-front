import { ComponentIconSchemaSettingsMap } from ".";
import { ComponentSchemaSettings, valdiateComponentSetting } from "../core";

export function parseIconComponentSettings(settings: ComponentSchemaSettings): ComponentSchemaSettings {
    ...
    for (let setting in settings) {
        ...
        let settingConfig = (ComponentIconSchemaSettingsMap as any)?.[settingName];
