import { ComponentCarouselBoxSchemaSettingsMap } from ".";
import { ComponentSchemaSettings, valdiateComponentSetting } from "../core";

export function parseCarouselBoxComponentSettings(settings: ComponentSchemaSettings): ComponentSchemaSettings {
    ...
    for (let setting in settings) {
        ...
        let settingConfig = (ComponentCarouselBoxSchemaSettingsMap as any)?.[settingName];
