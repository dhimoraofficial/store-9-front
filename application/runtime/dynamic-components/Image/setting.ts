import { ComponentImageSchemaSettingsMap } from ".";
import { ComponentSchemaSettings, valdiateComponentSetting } from "../core";

export function parseImageComponentSettings(settings: ComponentSchemaSettings): ComponentSchemaSettings {
    ...
    for (let setting in settings) {
        ...
        let settingConfig = (ComponentImageSchemaSettingsMap as any)?.[settingName];
